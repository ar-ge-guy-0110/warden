            ...
            <div class="glass_table_container">
                ...
                <table class="glass_table">
                    ...
                    <tbody>
                        ...
                        -->
                        <tr>
                            <form id="addform" action="action_addunit.php" method="POST">
                                <td data-label="Birim Numarası">-</td>
                                <td data-label="Birim İsmi"><input type="text" class="custominput" name="unit_name" placeholder="Birim İsmi"></td>
