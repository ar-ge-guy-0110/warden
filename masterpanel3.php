    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="glass_table_container">
                <h1 class="heading">Nöbet Tanımları</h1>
                <table class="glass_table">
                    ...
                    <tbody>
                        ...
                        -->
                        <tr>
                            <form id="addform" action="action_addwatch.php" method="POST">
                                <td data-label="Nöbet Numarası">-</td>
                                <td data-label="Başlangıç Tarihi"><input type="datetime-local" class="custominput" name="watch_start" placeholder="Başlangıç Tarihi"></td>
                                <td data-label="Bitiş Tarihi"><input type="datetime-local" class="custominput" name="watch_end" placeholder="Bitiş Tarihi"></td>
                                <td data-label="Nöbetçi">   
