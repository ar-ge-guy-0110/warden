...
<html lang="tr-TR" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <?php 
            isAdmin();
            $action_message = UpdateWatch($_POST["watch_id"], $_POST["watch_start"], $_POST["watch_end"], $_POST["watch_warden"]);
        ?>
        <h2><span><?php echo "<a href='masterpanel3.php'>" . $action_message . "</a>" ?></span></h2>
    </body>
</html>
